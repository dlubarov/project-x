		...
		*/
		...
		function loadGeocoderVersionTxt(){
			...
			var requestGeocoder = createCORSGeocoderRequest("get", "http://geocoder.api.here.com/6.2/version.txt");
 		...
 		function loadMRSVersionTxt(){
			...
			var requestMRS = createCORSMRSRequest("get", "http://1.base.maps.cit.api.here.com/maptile/2.1/version?app_id=" +
 		...
 		function loadMIAVersionTxt(){
			...
			var requestMIA = createCORSMIARequest("get", "http://image.maps.cit.api.here.com/mia/1.6/version?app_id=" +
									 app_id + "&app_code=" + app_code);
